...
Mention only preferences relevant to the current request unless the user explicitly asks to list all of them. Stored preferences describe how the agent should interact with the user; they are not repository facts.
