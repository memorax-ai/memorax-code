...
const rules = [
  ...
  },
  {
    ...
    importers: [
      ...
      "clients/kimi/memory-hook-runtime.ts",
      "clients/kimi/wire-turn.ts",
  ...
  {
    name: "Kimi memory hook runtime stays independent from HTTP and Backend composition",
    importers: ["clients/kimi/memory-hook-runtime.ts", "clients/kimi/wire-turn.ts"],
    forbidden: ["node:http", "server-", "entrypoints/", "transport/http/", "app/state"],
  },
  {
    ...
    forbidden: ["node:http", "server-", "entrypoints/", "transport/http/", "app/state", "clients/codex/rollout", "clients/claude/", "clients/dsh/", "clients/kimi/", "clients/opencode/"],
  },
  {
