...
const reviewedNetworkSources = new Set([
  ...
  "packages/ts/memorax-code-dsh-adapter/src/backend-client.mjs",
...
function sourcePathForArtifact(rawPath) {
  ...
  if (path.startsWith("lib/memorax-code-dsh-adapter/skills/memorax-code/")) {
    return `packages/ts/memorax-code-codex-adapter/skills/memorax-code/${path.slice("lib/memorax-code-dsh-adapter/skills/memorax-code/".length)}`;
  }
  if (path.startsWith("lib/memorax-code-dsh-adapter/src/")) {
    return `packages/ts/memorax-code-dsh-adapter/src/${path.slice("lib/memorax-code-dsh-adapter/src/".length)}`;
  }
