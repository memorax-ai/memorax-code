...
Failed explicit Search/Add commands and Backend start/stop/restart failures
provide an error code, recovery guidance, and a local content-free diagnostic;
