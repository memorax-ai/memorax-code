...
Failures in setup, explicit Search/Add, Backend start/stop/restart, and client
deployment provide an error code, recovery guidance, and a local content-free
diagnostic; see [failure recovery](docs/troubleshooting.md).
